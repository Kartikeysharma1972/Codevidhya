  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 -left-20 w-72 h-72 bg-sky-200 rounded-full filter blur-[80px] opacity-40 animate-blob-2"></div>
      </div>

      <div className="relative w-full max-w-md">
        <Link to="/" className="flex items-center justify-center gap-2.5 mb-7 group">
        ...
        <div className="bg-white/80 backdrop-blur-md border border-white/60 rounded-3xl p-7 shadow-[0_30px_60px_-25px_rgba(15,23,42,0.18)]">
          <h2 className="font-display font-extrabold text-2xl text-gray-900 text-center">Welcome back</h2>
          <p className="text-[13px] text-gray-500 text-center mt-1">Sign in to keep learning where you left off.</p>
          ...
          <p className="text-center text-[13px] text-gray-500 mt-6">
            New here? <Link to="/signup" className="text-primary-600 font-semibold hover:underline">Create an account</Link>
          </p>
        </div>
